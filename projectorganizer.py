...
class OrganizerApp:
    def __init__(self, root):
        ...
        self.button_bg = "#E53935"  # Bright red
        self.button_fg = "#f4f6f7"  # Light text for contrast
        ...
        tk.Button(root, text="Browse", command=self.browse_source, font=self.font, bg=self.button_bg, fg=self.button_fg, activebackground="#FF8A80", activeforeground=self.button_fg, relief='flat').grid(row=1, column=2, padx=(5, 15), pady=5)
        # Destination
        ...
        tk.Button(root, text="Browse", command=self.browse_dest, font=self.font, bg=self.button_bg, fg=self.button_fg, activebackground="#FF8A80", activeforeground=self.button_fg, relief='flat').grid(row=2, column=2, padx=(5, 15), pady=5)
        ...
        # Start button
        self.organize_btn = tk.Button(root, text="Organize", command=self.start_organize, font=("Segoe UI", 12, "bold"), bg=self.button_bg, fg=self.button_fg, activebackground="#FF8A80", activeforeground=self.button_fg, relief='flat')
